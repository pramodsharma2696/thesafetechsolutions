(function ($) {
    ...
    var carouselSlider = new Swiper('.img-slider', {
        slidesPerView : 4,
        slidesPerGroup: 1,
        loop: true,
        speed: 1000,
...
// $('.form-popup').on('click', '.contact-form-service-wrap', function(e) {
//     e.stopPropagation();
// });
...
$(document).ready(function(){
    ...
    $(".dashboard-title").click(function(){
        $(this).parent(".dashboard-item").find(".dashboard-content").slideToggle();
        $(this).parent(".dashboard-item").prevAll(".dashboard-item").find(".dashboard-content").slideUp();
        $(this).parent(".dashboard-item").nextAll(".dashboard-item").find(".dashboard-content").slideUp();
        let a = $(this).data("url");
        $('#change-img').prop('src', a)
        // console.log('url', a);
    });
});
// $('.dashboard-title').click(function () { 
...
//     if (c.includes("close")) {
//         console.log("enter");
//         $(".dashboard-title").removeClass("open")
//         $(".dashboard-content").removeClass("open-content")
//         $(".dashboard-title").addClass("close")
//         $(".dashboard-content").addClass("close-content")
//         $(this).siblings().removeClass('close-content');
//         console.log("dsdsadsdad", $(this).siblings());
//         $(this).siblings().addClass('open-content');
//     } 
// });